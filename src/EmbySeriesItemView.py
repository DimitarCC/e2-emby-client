...
class EmbySeriesItemView(EmbyItemView):
	skin = ["""<screen name="EmbySeriesItemView" position="fill">
					...
					<widget name="episodes_list" position="40,630" size="e-80,408" iconWidth="407" iconHeight="220" font="Regular;22" scrollbarMode="showNever" iconType="Primary" listOrientation="orHorizontal" transparent="1"/>
					...
					<widget name="list_cast" position="40,1250" size="e-80,426" iconWidth="180" iconHeight="270" font="Regular;20" scrollbarMode="showNever" iconType="Primary" listOrientation="orHorizontal" transparent="1"/>
					...
					<widget name="list_chapters" position="40,1800" size="e-80,426" iconWidth="407" iconHeight="220" font="Regular;22" scrollbarMode="showNever" iconType="Chapter" listOrientation="orHorizontal" transparent="1"/>
				</screen>"""]
