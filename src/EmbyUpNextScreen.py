...
class EmbyUpNextScreen(Screen):
	skin = ["""<screen name="EmbyUpNextScreen" position="fill" flags="wfNoBorder" zPosition="1000" backgroundColor="#FF000000">
					...
					<widget name="countdown_label" position="600,365" size="400,35" font="Regular;26" transparent="1" foregroundColor="#ffffff"/>
					<widget source="countdown_progress" render="Progress" position="600,420" size="e-660,10" backgroundColor="#02333333" foregroundColor="#32772b" cornerRadius="4" transparent="1"/>
					<widget name="function_buttons" position="90,400" size="480,80" font="Regular;28" transparent="1"/>
				</screen>"""]  # noqa: E101
